...
$(function () {
  ...
  var sidebar_dropdown = function () {
    var li = $(".main-sidebar .sidebar-menu li.active ");
    if (li.hasClass("dropdown.active")) {
      $(".main-sidebar .sidebar-menu li.active a").css(
        "background-color",
        "#343a40"
      );
    }
    ...
    if ($(".main-sidebar").length) {
      ...
      // Move scroll to active item after sidebar is fully initialized
      if (li.length) {
        setTimeout(function () {
          var activeItem = li[0];
          var container = $(".main-sidebar");
          if (container.length && $(activeItem).offset()) {
            var scrollTo =
            ...
            var maxScroll = container[0].scrollHeight - container.height();
            scrollTo = Math.min(
              Math.max(0, scrollTo - container.height() / 3),
              maxScroll
            );
            ...
            // Update nicescroll after animation
            setTimeout(function () {
      ...
      var ul = $("ul.dropdown-menu").css("background-color", "#343a40");
      ul.parent().css("background-color", "#343a40");
  ...
  $(".main-content").css({
    minHeight: $(window).outerHeight() - 88,
  });
