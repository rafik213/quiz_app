                                        ...
                                        <form method="post" class="needs-validation" novalidate="" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    <a class='btn btn-primary' href='<?= base_url(); ?>assets/contest-data-format.csv' target="_blank" download> <em class='fas fa-download'></em> <?= lang('download_sample_file_here'); ?></a>
                                                </div>
                                            </div>
                                        </form>
                                        <div class="mt-4">
