...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <ul class="sidebar-menu">
            ...
            <!-- Dashboard & Users -->
            <li class="menu-header">Dashboard & Users</li>
            <li>
            ...
            <!-- Quiz Management -->
            <li class="menu-header">Quiz Management</li>
            ...
            <!-- Learning Modules -->
            <li class="menu-header">Learning Modules</li>
            ...
            <!-- Game Modules -->
            <li class="menu-header">Game Modules</li>
            ...
            <?php if ($this->session->userdata('authStatus')) { ?>
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)" class="nav-link has-dropdown"><em class="fas fa-mobile-alt"></em><span><?= lang('app_settings'); ?></span></a>
                    <ul class="dropdown-menu">
            ...
            <?php if ($this->session->userdata('authStatus')) { ?>
                <li class="nav-item dropdown">
                    <a href="javascript:void(0)" class="nav-link has-dropdown"><em class="fas fa-file-alt"></em><span><?= lang('content_management'); ?></span></a>
                    <ul class="dropdown-menu">
